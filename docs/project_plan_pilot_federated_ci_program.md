...
> Migration notice (2026-03-03):
> Canonical working copy for this plan is now maintained in:
> `/home/irbsurfer/Projects/arqon/ArqonPilot/docs/federated-ci-program-plan.md`
> 
> This file is retained as a legacy reference to prevent broken links in older notes.
> New implementation work should use the ArqonPilot-local plan to avoid cross-repo drift.
...
Before coding, the implementing AI must read these in order:sh`
